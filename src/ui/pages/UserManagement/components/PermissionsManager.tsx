...
import { ArrowLeft, ShieldCheck, Plus, Trash } from 'lucide-react';
  ...
  return (
    <div className="space-y-6">
      <PageHeader
        ...
        description={`Configure role and permissions for ${userDisplayName}`}
                ...
                <div className="space-y-2">
                  {permissionsData.explicitPermissions?.length > 0 ? (
                    permissionsData.explicitPermissions.map((perm: any) => (
                      <div key={perm.permission} className="flex items-center justify-between p-2 bg-gray-50 dark:bg-gray-700 rounded">
