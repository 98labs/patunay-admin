-- Update add_artwork function to include organization_id parameter
...
COMMENT ON FUNCTION public.add_artwork IS 'Adds a new artwork with optional NFC tag and organization association';